...
namespace Alg_lab_2.Model
{
    public static class ImportData
    {
        ...
        public static readonly int MaxValueForHanoi = 12;
        ...
        public static readonly List<String> RingColors = new List<String> { "#FF3EFF", "#B94FFF", "#7744FF", "#5555FF", "#5599FF", "#33FFFF", "#33FF33", "#CCFF33", "#FFFF33", "#FFAA33", "#FF7744", "#FF3333" };
